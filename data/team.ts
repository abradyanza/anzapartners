...
export const FOUNDERS: TeamMember[] = [
  {
    ...
    bio: [
      ...
      "Prior to Moelis, Zach worked at Garnett Station Partners, a New York based Private Equity firm focusing on investment in consumer and services businesses.",
      "Zach holds a degree in Applied Engineering Physics from Cornell University.",
    ],
  },
  {
    name: "Andrew Brady",
    ...
    bio: [
      ...
      "Prior to Bain Capital, Andrew was with J.P. Morgan where his focus was mergers & acquisitions advisory and capital raising for Tech, Media, and Telecom companies.",
      "Andrew graduated Summa Cum Laude with a degree in Applied Economics & Management / Finance from Cornell University, where he was a Dyson Scholar.",
    ],
  },
];
...
export const ADVISORS: TeamMember[] = [
  {
    ...
    bio: [
      ...
      "Through his family office, Michael has invested behind a number of start-ups, small businesses, and real estate development projects.",
      "Michael is an active philanthropist and has served on the boards of a number of philanthropic organizations such as OLA of Eastern Long Island, The Statue of Liberty and Ellis Island Foundation, and The American Friends of Winchester College.",
    ],
  },
  {
    name: "Gregg Monastiero",
    initials: "GM",
    title: "Operating Partner",
    ...
    bio: [
      ...
      "Through his family office, he has owned and operated a number of small firms such as franchised restaurants, construction / development, etc.",
      "Gregg holds an MBA from Babson College's Olin School of Business and is a graduate of Merrimack College.",
    ],
  },
  {
    name: "Royce Yudkoff",
    ...
    bio: [
      ...
      "Through his family office, Royce is an active private investor in dozens of small firms and serves on multiple boards.",
      "Royce is a graduate of Dartmouth College and holds an MBA from Harvard Business School, where he was a Baker Scholar.",
    ],
  },
  {
    name: "Matt Perelman",
